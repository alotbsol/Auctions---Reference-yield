...
def scenario4_other_costs_production():
    df_results = pd.DataFrame()
    ...
    for iii in demand_scenarios:
        ...
        Master_storage = projects.ProjectsStorage(demand=demand, name="scenario4_other_costs_production",
                                                  ref_yield_scenarios=ref_yield_scenarios,
                                                  project_size_adjustment=3)
    ...
    writer = pd.ExcelWriter("scenario4_other_costs_production.xlsx", engine="xlsxwriter")
    df_results.to_excel(writer, sheet_name="Results")
    writer.save()
...
if __name__ == '__main__':
    ...
    scenario4_other_costs_production()
